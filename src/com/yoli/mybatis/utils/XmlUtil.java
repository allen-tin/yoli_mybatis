 ...
 * 
 */
package com.yoli.mybatis.utils;
...
import com.yoli.mybatis.constants.Constant.SqlType;
...
public final class XmlUtil {
    ...
    public static void readMapperXml(File fileName, Configuration configuration) {
        ...
        try {
            System.out.println("");
            System.out.println("");
            System.out.println("====开始读取Mapper XML文件=====");
            // 创建一个读取器
            ...
            for (Iterator iterator = rootElement.elementIterator(); iterator.hasNext();)
            {
                ...
                System.out.println("mapper文件里面sqlId=="+sqlId);
                System.out.println("mapper文件里面statement=="+statement);
                configuration.addMappedStatement(sqlId, statement);
                
                //这里其实是在MapperRegistry中生产一个mapper对应的代理工厂
                System.out.println("通过namespace在MapperRegistry中生产一个mapper对应的代理工厂");
